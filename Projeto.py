...
# funcionou perfeitramente e quebrou um galho, e claro, foi o meu primeiro projeto autonomo
# a epoca, por exemplo, eu não conhecia a possibilidade de se criar funções para otimizar rotinas de código.
